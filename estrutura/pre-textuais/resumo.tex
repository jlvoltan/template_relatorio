...
\textbf{Palavras-chave}: palavra; Brasil; IBGE; outra palavra.
%Devem ser grafadas com inicial da letra em minúscula, com exceção de substantivos próprios ou nomes científicos.
\end{SingleSpacing}
\end{resumo}
...
%Palavras-chave: gestação; cuidado pré-natal; Aedes Aegypti; IBGE;